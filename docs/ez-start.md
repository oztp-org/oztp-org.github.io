<style>
  .assessment-container { font-size: 10px; }
...
<button onclick="updateScore(this, 0, 'q1')">🔴</button>
<button onclick="updateScore(this, 1, 'q1')">🟠</button>
<button onclick="updateScore(this, 2, 'q1')">🟡</button>
<button onclick="updateScore(this, 3, 'q1')">🔵</button>
